...
export class PurchaseStateCreateAdminComponent extends AbstractCreateController<PurchaseStateDto, PurchaseStateCriteria, PurchaseStateAdminService>  implements OnInit {
