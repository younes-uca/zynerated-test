package ma.zs.collaborator.zynerator.controller;
...
import ma.zs.collaborator.zynerator.dto.BaseDto;
import ma.zs.collaborator.zynerator.dto.FileTempDto;
import ma.zs.collaborator.zynerator.exception.BusinessRuleException;
import ma.zs.collaborator.zynerator.exception.GlobalException;
import ma.zs.collaborator.zynerator.export.ExportModel;
import ma.zs.collaborator.zynerator.service.IService;
import ma.zs.collaborator.zynerator.util.*;
...
public class AbstractController<T extends AuditBusinessObject, DTO extends BaseDto, Criteria extends BaseCriteria, SERV extends IService<T, Criteria>, CONV extends AbstractConverter<T, DTO>> {
